...
using IdentityServer.Configuration.ApplicationParts;
...
using IdentityServer.EntityFramework.MySql.Extensions;
using IdentityServer.EntityFramework.PostgreSQL.Extensions;
using IdentityServer.EntityFramework.Repositories;
using IdentityServer.EntityFramework.Repositories.Interfaces;
using IdentityServer.EntityFramework.Shared.Configuration;
